...
function setupHandlers(app) {
  ...
  app.get("/", (req, res) => {
    // Make a request to the /ads microservice endpoint
    http
      .get(
        {
          host: "advertising",
        ...
        (response) => {
          ...
          response.on("end", () => {
            ...
            // Make a request to the metadata microservice endpoint
            http
              .get(
                {
                  host: "metadata",
              ...
              .get(
                ...
                (response) => {
                  ...
                  response.on("end", () => {
                    ...
                    res.render("play-video", { video, ads });
                  });
      ...
      .get(
        ...
        (response) => {
          ...
          response.on("end", () => {
            ...
            // Renders the upload form for display in the browser.
  ...
  app.get("/history", (req, res) => {
    http
      .request(
        // Gets the viewing history from the history microservice.
        {
          host: `history`,
          path: `/videos`,
          method: `GET`,
